...
import org.springframework.stereotype.Service;
    ...
    public class GeminiLivePatchNotesService {
        ...
        public LivePatchNoteDTO fetchLivePatchNotes(String techName) {
            try { //takes in array of user favorites via the names of each tech and generates a patch note for each one
                String query = "Search for the latest patch notes for" + techName + "and return a concise summary. If unavailable, provide a brief summary of important changes within the newest version found. The description field must be under 255 characters.";
